...
-- Indexes for matches
CREATE INDEX IF NOT EXISTS idx_matches_user_id ON matches(user_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_matches_start_date ON matches(start_date DESC) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_matches_opponent_name ON matches(opponent_name) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_matches_active ON matches(deleted_at) WHERE deleted_at IS NULL;
...
-- Indexes for games
CREATE INDEX IF NOT EXISTS idx_games_match_id ON games(match_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_games_match_game_number ON games(match_id, game_number) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_games_start_date ON games(start_date DESC) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_points_match_id ON points(match_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_points_game_id ON points(game_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_points_timestamp ON points(timestamp DESC) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_points_game_number ON points(game_number) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_points_outcome ON points(outcome) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_points_match_game ON points(match_id, game_number) WHERE deleted_at IS NULL;

-- GIN index for JSONB metadata (for flexible queries)
CREATE INDEX IF NOT EXISTS idx_points_metadata ON points USING GIN (metadata) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_matches_metadata ON matches USING GIN (metadata) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_games_metadata ON games USING GIN (metadata) WHERE deleted_at IS NULL;
